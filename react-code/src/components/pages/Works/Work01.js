    ...
    return (
        <>
            <WorkIntro
                ...
                웹사이트에 아이덴티티를 부여했습니다. React를 활용해서 추후 작업물을 업데이트하고,
                관리할 수 있도록 UI를 컴포넌트화 하여 유지보수에 도움될 수 있도록 작업했습니다."
            ></WorkIntro>
            <WorkImageBox
            size="over"
            ...
            단순하게 텍스트로 이루어진 로고이지만, 애니메이션 효과로 아이덴티티를 담고 있습니다."
            ></WorkTextBox>
            <WorkImageBox
            size="max"
            ...
            <WorkTextBox
            size="md"
            desc="나는 호기심이 많아, 궁금한 것에 대한 집요한 관심을 가집니다. 
            정돈된 코드와 문서화된 규정을 좋아하면서도 개성있는 디자인과 자유로움을 추구합니다."
            ></WorkTextBox>
            <WorkImageBox
            size="over"
            ...
            <WorkTextBox
            size="md"
            desc="웹사이트 전반에 '기호'를 사용하지 않고, 정제된 글과 색으로만 구성되도록 디자인하였습니다. 
            ...
            방문자의 관심도에 따라, 홈 화면에서 해당하는 페이지로 이동이 가능하도록 설계되었습니다."
            ></WorkTextBox>
        </>
    )
}
