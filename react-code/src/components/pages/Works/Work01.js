    ...
    return (
        <>
            <WorkIntro
                ...
                관리할 수 있도록 UI를 컴포넌트화하여 유지 보수에 도움 될 수 있도록 작업했다."
            />
            <WorkImageBox
            size="over"
            ...
            정돈된 코드와 문서화된 규칙을 좋아하면서도 개성 있는 디자인과 자유로움을 추구한다.
            ...
            겉으로 보기에는 단순하게 텍스트로 이루어진 로고이지만, 애니메이션 효과로 내면의 잠재력이나 개성과 같은 아이덴티티를 담고 있다. "
            />
            ...
            겉으로 보기에 따분하고 정돈된 웹사이트처럼 보이지만, 강렬한 형광색 컬러의 동적인 효과들로
            내면의 숨겨진 개성을 담고자 했다."
            />
            <WorkImageBox
            size="max"
            ...
            <WorkTextBox
            size="md"
            desc="페이지 간 이동은 내비게이션을 통해서 이동이 가능하다.
            ...
            <WorkTextBox
            size="md"
            desc="홈페이지에서는 모든 콘텐츠를 요약해서 대략적으로 확인할 수 있다.
            관심도에 따라 작품이나 소개 페이지로 이동이 가능하고, 메뉴를 통해서 페이지 이동이 가능하다."
            />
            <WorkImageBox
            size="over"
            ...
            <WorkTextBox
            size="md"
            desc="PC, 모바일 등의 다른 디바이스에서 접속하여도 화면 크기에 따라 가변적으로 레이아웃이 변하지만 일관된 느낌을 전달한다."
            />
            <ReturnToWorks/>
        </>
    )
