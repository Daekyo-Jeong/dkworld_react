    ...
    return (
        <>
            <WorkIntro
                ...
                지정된 사운드가 출력된다. 또 요리 별로로 조합을 지정 해 두어서 특정 조합이 완성되면 사운드와 
                함께 이미지가 재생된다."
            ></WorkIntro>
            ...
            마치 요리를 하는 듯한 느낌을 줄 수 있도록 손동작을 인식하는 '립모션'을 활용하여 제작했다. 
             맛있는 음식을 만들때의 기쁨을 표현했다."
            ></WorkTextBox>
            <WorkImageBox
            size="max"
            ...
            <WorkTextBox
            size="md"
            desc="립모션을 통해 손 동작을 감지하고, 음식을 손으로 쥐어 냄비 속에 집어 넣으면 음악이 재생됩니다."
            ></WorkTextBox>
